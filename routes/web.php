...
//เมนู Product
Route::get('admin/product/index',[ProductController::class, 'index'])->name('i.product');
Route::get('admin/product/createfrom',[ProductController::class, 'createfrom'])->name('i.createfrom');
